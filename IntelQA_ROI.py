...
def calculate_roi_synthetic(revenue_increase, cost_savings, productivity_gains, development_costs, maintenance_costs, training_costs, licensing_costs, cloud_costs, support_ops_costs, people_removed, average_salary, time_saved_hours, hourly_rate):
...
st.title('ROI Calculator for Synthetic Data')
...
def on_calculate_button_clicked():
    ...
    try:
        ...
        results = calculate_roi_synthetic(**inputs)
...
def generate_graphs(inputs, results):
    ...
    st.markdown("""
        <p><strong>Explanation:</strong> This graph illustrates how different revenue components contribute to total benefits, helping prioritize areas with the highest potential for ROI improvement.</p>
        """, unsafe_allow_html=True)
    ...
    st.markdown("""
        <p><strong>Explanation:</strong> This graph shows the cost distribution, helping identify major cost drivers and areas where optimization can reduce total costs.</p>
        """, unsafe_allow_html=True)
    ...
    st.markdown("""
        <p><strong>Explanation:</strong> This graph compares total benefits with total costs, demonstrating whether the investment in Synthetic Data results in a net gain.</p>
        """, unsafe_allow_html=True)
    ...
    st.markdown("""
        <p><strong>Explanation:</strong> This graph highlights the value of reducing personnel costs and saving time, leading to significant operational efficiency improvements.</p>
        """, unsafe_allow_html=True)
    ...
    st.markdown("""
        <p><strong>Explanation:</strong> This line chart shows the projected increase in ROI over three years, assuming consistent revenue growth and cost optimization.</p>
        """, unsafe_allow_html=True)
    ...
    st.markdown("""
        <p><strong>Explanation:</strong> This graph displays the cumulative impact of various savings sources over time, indicating increasing benefits year-over-year.</p>
        """, unsafe_allow_html=True)
    ...
    st.markdown("""
        <p><strong>Explanation:</strong> This graph shows how net benefits are expected to grow over three years, reinforcing the long-term value of investing in Synthetic Data.</p>
        """, unsafe_allow_html=True)
...
def generate_summary(inputs, results):
    ...
    <p><strong>Explanation:</strong> This ROI summary provides key financial metrics derived from adopting Synthetic Data, highlighting significant cost reductions, time savings, and overall financial benefits. The ROI status indicates whether the investment yields a positive or negative return, helping stakeholders assess the financial impact effectively.</p>
    """
